...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> home: sidebar lists at least one home-project row (requires auth in Angular)
- Location: specs/migration-audit.spec.ts:113:3
