...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> forgot-password: document title is Forgot password - Taiga
- Location: specs/migration-audit.spec.ts:152:3
...
Expected pattern: /Forgot password - Taiga/
