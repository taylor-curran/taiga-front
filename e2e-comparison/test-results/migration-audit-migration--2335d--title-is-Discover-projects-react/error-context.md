...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> discover: h1 page title is Discover projects
- Location: specs/migration-audit.spec.ts:62:3
...
Locator: locator('.discover-header h1.title')
Expected: "Discover projects"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toHaveText" with timeout 5000ms
  - waiting for locator('.discover-header h1.title')
