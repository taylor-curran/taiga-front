...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> login: password field placeholder (discrimination string)
- Location: specs/migration-audit.spec.ts:43:3
