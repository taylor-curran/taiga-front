...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> not-found: error heading is Not found
- Location: specs/migration-audit.spec.ts:196:3
...
Locator: getByRole('heading', { name: 'Not found' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Not found' })
