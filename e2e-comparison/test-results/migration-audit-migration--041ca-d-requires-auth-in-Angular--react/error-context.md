...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> home: main dashboard heading is Projects Dashboard (requires auth in Angular)
- Location: specs/migration-audit.spec.ts:93:3
...
Locator: getByRole('heading', { name: 'Projects Dashboard', exact: true }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Projects Dashboard', exact: true }).first()
