...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> forgot-password: primary button is Reset Password
- Location: specs/migration-audit.spec.ts:171:3
...
Locator: locator('.forgot-form-container button.btn-small')
...
Call log:
  ...
  - waiting for locator('.forgot-form-container button.btn-small')
