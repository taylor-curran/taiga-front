...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> login: h2 tagline includes LOVE YOUR PROJECT
- Location: specs/migration-audit.spec.ts:30:3
...
Locator: locator('h2.tagline')
Expected substring: "LOVE YOUR PROJECT"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('h2.tagline')
