...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> register: document title is Register - Taiga
- Location: specs/migration-audit.spec.ts:177:3
...
Expected pattern: /Register - Taiga/
