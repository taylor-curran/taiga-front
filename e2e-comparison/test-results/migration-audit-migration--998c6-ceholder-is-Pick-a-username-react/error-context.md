...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> register: username input placeholder is Pick a username
- Location: specs/migration-audit.spec.ts:183:3
...
Call log:
  - waiting for locator('form.register-form input[name="username"]')
