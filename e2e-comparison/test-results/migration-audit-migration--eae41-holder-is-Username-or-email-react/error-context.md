...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> forgot-password: single-line input placeholder is Username or email
- Location: specs/migration-audit.spec.ts:164:3
...
Call log:
  - waiting for locator('form[ng-submit] input[name="username"], .forgot-form-container input[name="username"]').first()
