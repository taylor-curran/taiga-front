...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> project home: h1 project name is non-empty (requires auth in Angular)
- Location: specs/migration-audit.spec.ts:123:3
...
Call log:
  - waiting for locator('h1.project-name')
