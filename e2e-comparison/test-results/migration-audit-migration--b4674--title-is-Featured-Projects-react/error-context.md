...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> discover: featured section title is Featured Projects
- Location: specs/migration-audit.spec.ts:75:3
...
Locator: getByRole('heading', { name: 'Featured Projects' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Featured Projects' })
