...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> discover: most liked block title is Most liked
- Location: specs/migration-audit.spec.ts:81:3
...
Locator: getByRole('heading', { name: 'Most liked' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Most liked' })
