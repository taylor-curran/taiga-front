...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> not-found: Go home link text is Take me home
- Location: specs/migration-audit.spec.ts:202:3
...
Locator: getByRole('link', { name: 'Take me home' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: 'Take me home' })
