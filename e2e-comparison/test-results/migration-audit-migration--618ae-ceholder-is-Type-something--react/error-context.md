...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> discover: search placeholder is Type something...
- Location: specs/migration-audit.spec.ts:68:3
...
Call log:
  - waiting for locator('.searchbox input[name="search"]')
