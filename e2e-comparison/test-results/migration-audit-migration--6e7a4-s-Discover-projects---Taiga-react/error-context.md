...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> discover: document title is Discover projects - Taiga
- Location: specs/migration-audit.spec.ts:208:3
...
Expected pattern: /Discover projects - Taiga/
