...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> login: primary submit button says Login
- Location: specs/migration-audit.spec.ts:56:3
...
Locator: locator('form.login-form button[type="submit"]')
Expected: "Login"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('form.login-form button[type="submit"]')
