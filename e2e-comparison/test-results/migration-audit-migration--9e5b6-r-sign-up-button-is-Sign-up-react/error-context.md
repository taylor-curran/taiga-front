...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> register: sign-up button is Sign up
- Location: specs/migration-audit.spec.ts:190:3
