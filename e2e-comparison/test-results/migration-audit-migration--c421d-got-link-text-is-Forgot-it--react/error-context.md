...
- Name: migration-audit.spec.ts >> migration audit — Angular is source of truth >> login: forgot link text is Forgot it?
- Location: specs/migration-audit.spec.ts:50:3
...
Call log:
  ...
  - waiting for locator('a.forgot-pass')
